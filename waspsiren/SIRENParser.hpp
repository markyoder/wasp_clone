...
#line 204 "SIRENParser.hpp"
    ...
    struct basic_symbol : Base
    {
      ...
      {
        return SIRENParser::symbol_name (this->kind ());
      }
...
#if 201103L <= YY_CPLUSPLUS
    /// Non copyable.
    SIRENParser (const SIRENParser&) = delete;
    /// Non copyable.
    SIRENParser& operator= (const SIRENParser&) = delete;
#endif
    ...
    {
    public:
      context (const SIRENParser& yyparser, const symbol_type& yyla);
