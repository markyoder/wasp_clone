...
#define YY_DECL                                            \
    wasp::ExprParser::token_type wasp::ExprLexerImpl::lex( \
 ...
 * yylex() function to be contained within the ExprLexerImpl class. This is
 * required
...
class WASP_PUBLIC ExprLexerImpl : public ExprFlexLexer
{
  public:
    ...
    */
    ...
    virtual ExprParser::token_type lex(ExprParser::semantic_type *yylval,
