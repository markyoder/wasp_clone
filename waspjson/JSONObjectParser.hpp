...
#line 10 "JSONObjectParser.bison"
...
#line 210 "JSONObjectParser.hpp"
    ...
    INTEGER = 259,                 // "integer"
    TOKEN_TRUE = 260,              // "true"
    TOKEN_FALSE = 261,             // "false"
    TOKEN_NULL = 262,              // "null"
    DOUBLE = 263,                  // "double"
    QSTRING = 264                  // "quoted string"
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_INTEGER = 4,                           // "integer"
        S_TOKEN_TRUE = 5,                        // "true"
        S_TOKEN_FALSE = 6,                       // "false"
        S_TOKEN_NULL = 7,                        // "null"
        S_DOUBLE = 8,                            // "double"
        S_QSTRING = 9,                           // "quoted string"
        S_10_ = 10,                              // '['
        S_11_ = 11,                              // ']'
        S_12_ = 12,                              // '{'
        S_13_ = 13,                              // '}'
        ...
        S_primitive = 17,                        // primitive
        S_decl = 18,                             // decl
        S_array = 19,                            // array
        S_object = 20,                           // object
        S_array_members = 21,                    // array_members
        S_keyed_member = 22,                     // keyed_member
        S_object_members = 23,                   // object_members
        S_start = 24                             // start
      };
    };
    ...
    struct basic_symbol : Base
    {
      ...
      {
        return JSONObjectParser::symbol_name (this->kind ());
      }
...
#if 201103L <= YY_CPLUSPLUS
    /// Non copyable.
    JSONObjectParser (const JSONObjectParser&) = delete;
    /// Non copyable.
    JSONObjectParser& operator= (const JSONObjectParser&) = delete;
#endif
    ...
    {
    public:
      context (const JSONObjectParser& yyparser, const symbol_type& yyla);
    ...
    private:
      const JSONObjectParser& yyparser_;
...
#if YY_CPLUSPLUS < 201103L
    /// Non copyable.
    JSONObjectParser (const JSONObjectParser&);
    /// Non copyable.
    JSONObjectParser& operator= (const JSONObjectParser&);
#endif
