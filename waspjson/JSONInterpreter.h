...
namespace wasp {
    ...
    /** The JSONInterpreter class brings together all components. It creates an instance of
     * the JSONParser and JSONLexerImpl classes and connects them. Then the input stream is
