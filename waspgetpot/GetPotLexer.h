...
#define YY_DECL                                                \
    wasp::GetPotParser::token_type wasp::GetPotLexerImpl::lex( \
 ...
 * yylex() function to be contained within the GetPotLexerImpl class. This is
 * required
...
class GetPotLexerImpl : public GetPotFlexLexer
{
  public:
    ...
    */
    ...
    virtual GetPotParser::token_type lex(GetPotParser::semantic_type* yylval,
