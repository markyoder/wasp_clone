...
SET(${PROJECT_NAME}_VERSION 3.1.3)
SET(${PROJECT_NAME}_FULL_VERSION "Workbench Analysis Sequence Processor 3.1.3")
SET(${PROJECT_NAME}_VERSION_STRING "3.1.3")
SET(${PROJECT_NAME}_MAJOR_VERSION 03)
SET(${PROJECT_NAME}_MAJOR_MINOR_VERSION 030103)
