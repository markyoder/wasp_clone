...
SET(${PROJECT_NAME}_VERSION 2.0.1)
SET(${PROJECT_NAME}_FULL_VERSION "Workbench Analysis Sequence Processor 2.0.1")
SET(${PROJECT_NAME}_VERSION_STRING "2.0.1")
SET(${PROJECT_NAME}_MAJOR_VERSION 02)
SET(${PROJECT_NAME}_MAJOR_MINOR_VERSION 020001)
