...
int main(int argc, char** argv)
{
    ...
    if (argc < 3)
    {
        std::cout << "Workbench Analysis Sequence Processor (DDI)" << std::endl
                  << argv[0]
                  << " : An application for selecting DDI formatted input."
                  << std::endl;
        std::cout << " Usage : " << argv[0]
                  << " path/to/DDI/formatted/input /path/to/definition.son "
