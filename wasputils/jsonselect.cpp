...
int main(int argc, char* argv[])
{
    ...
    if (argc < 2)
    {
        std::cout << "Workbench Analysis Sequence Processor (JSON)" << std::endl
                  << argv[0]
                  << " : An application for selecting JSON formatted input."
                  << std::endl;
        std::cout << " Usage : " << argv[0]
                  << " path/to/JSON/formatted/input 'siren select statement'..."
                  << std::endl
    ...
    DefaultJSONInterpreter interpreter(errors);
