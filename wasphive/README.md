...
Schema files for HIVE are written using the ***Standard Object Notation ([SON](/waspson/README.md)) Syntax***.  
...
***SIREN Expressions***, ***SON Syntax***, ***Grammar Files***, and ***Template Files*** are beyond the scope of this document, 
