...
7. [DDI](/waspddi/README.md#definition-driven-interpreter) - Definition Driven Interpreter (DDI) 
8. [HALITE](/wasphalite/README.md#hierarchial-input-template-expansion-engine-halite) - HierarchicAL Input Template Engine (HALITE) 
...
9. [Utils](/wasputils/README.md#command-line-utilities) - utilities for command line file interaction (listing, validating, selecting, etc.)
