...
template<class S>
bool SONInterpreter<S>::parse(std::istream& in, size_t startLine, size_t startColumn)
{
...
template<class S>
bool SONInterpreter<S>::parseString(const std::string &input, const std::string& sname, size_t startLine, size_t startColumn)
{
