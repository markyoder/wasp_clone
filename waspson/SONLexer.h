...
#define YY_DECL                                          \
    wasp::SONParser::token_type wasp::SONLexerImpl::lex( \
 ...
 * yylex() function to be contained within the SONLexerImpl class. This is
 * required
...
class WASP_PUBLIC SONLexerImpl : public SONFlexLexer
{
  public:
     ...
     * yylex(). */
    SONLexerImpl(class AbstractInterpreter &interpreter,
    ...
    virtual SONParser::token_type lex(SONParser::semantic_type *yylval,
    ...
    void capture_token(wasp::SONParser::semantic_type *yylval, wasp::NODE type);
