...
clang-format -style=file -i waspddi/DDILexer.cpp
clang-format -style=file -i waspddi/DDIParser.cpp
...
clang-format -style=file -i waspexpr/ExprLexer.cpp
clang-format -style=file -i waspexpr/ExprParser.cpp
...
clang-format -style=file -i waspgetpot/GetPotLexer.cpp
clang-format -style=file -i waspgetpot/GetPotParser.cpp
...
clang-format -style=file -i waspjson/JSONLexer.cpp
clang-format -style=file -i waspjson/JSONObjectLexer.cpp
clang-format -style=file -i waspjson/JSONObjectParser.cpp
clang-format -style=file -i waspjson/JSONParser.cpp
...
clang-format -style=file -i waspsiren/SIRENLexer.cpp
clang-format -style=file -i waspsiren/SIRENParser.cpp
...
clang-format -style=file -i waspson/SONLexer.cpp
