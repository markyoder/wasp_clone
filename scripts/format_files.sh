...
clang-format -style=file -i wasphit/HITInterpreter.h
clang-format -style=file -i wasphit/HITInterpreter.i.h
clang-format -style=file -i wasphit/HITLexer.h
clang-format -style=file -i wasphit/HITNodeView.h
clang-format -style=file -i wasphit/HITNodeView.cpp
clang-format -style=file -i wasphit/HITNodeView.i.h
...
clang-format -style=file -i wasphit/HITInterpreter.cpp
clang-format -style=file -i wasphit/test/tstHIT.cpp
clang-format -style=file -i wasphit/test/tstHIVE.cpp
...
clang-format -style=file -i wasputils/hitlist.cpp
clang-format -style=file -i wasputils/hitselect.cpp
clang-format -style=file -i wasputils/hitvalid.cpp
clang-format -style=file -i wasputils/hitxml.cpp
